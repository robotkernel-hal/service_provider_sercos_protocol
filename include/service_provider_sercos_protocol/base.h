...
#ifndef SERVICE_PROVIDER_SERCOS_PROTOCOL__BASE_H
#define SERVICE_PROVIDER_SERCOS_PROTOCOL__BASE_H
...
class base : public robotkernel::service_interface {
    public:
        ...
        base(std::string owner, std::string service_prefix)
            : robotkernel::service_interface(owner, service_prefix + ".sercos_protocol") {};
...
#endif // SERVICE_PROVIDER_SERCOS_PROTOCOL__BASE_H
